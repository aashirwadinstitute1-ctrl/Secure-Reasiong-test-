const questions = [
  ...
  {
    q: "If two positions of a dice are shown: Face 1 opposite to 3, Face 2 opposite to 6, then which face is opposite to 4?",
    options: ["1", "2", "5", "6"],
    correct: 2
  },
  {
  ...
  {
    q: "Arrange the words: Elephant, Eagle, Engine, End",
    options: ["Eagle, Elephant, Engine, End", "Eagle, Engine, End, Elephant", "Elephant, Eagle, Engine, End", "Engine, Eagle, Elephant, End"],
    correct: 1
  },
  {
    q: "Which word will be in the middle in dictionary order?",
    options: ["Gold", "Goat", "Goal", "Good"],
    correct: 2
  },
  {
